...
model.load_state_dict(torch.load('./final_mlec1/pytorch_model.bin'))
...
dataframe = pd.DataFrame(true_label)
dataframe.columns = ['anger', 'anticipation', 'disgust', 'fear', 'joy', 'love',
                     'optimism', 'pessimism', 'sadness', 'surprise', 'trust']

dataframe.to_csv('./ensemble_result/predictions_MlEC1.csv')
